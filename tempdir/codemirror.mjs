...
var InnerParse = class {
  constructor(parser4, parse, overlay, target, ranges) {
    this.parser = parser4;
    this.parse = parse;
    this.overlay = overlay;
    this.target = target;
...
var Facet = class {
  ...
  static define(config2 = {}) {
    return new Facet(config2.combine || ((a) => a), config2.compareInput || ((a, b) => a === b), config2.compare || (!config2.combine ? sameArray2 : (a, b) => a === b), !!config2.static, config2.enables);
  }
  of(value) {
...
var Language = class {
  constructor(data, parser4, extraExtensions = []) {
    this.data = data;
...
var ParseContext = class {
  ...
  static create(parser4, state, viewport) {
    return new ParseContext(parser4, state, [], Tree.empty, 0, viewport, [], null);
  }
  startParse() {
...
// node_modules/@begin/codemirror/dist/index.js
var snippets = [
...
var javascriptLanguage2 = /* @__PURE__ */ LRLanguage.define({
  parser: /* @__PURE__ */ parser.configure({
    props: [
      /* @__PURE__ */ indentNodeProp.add({
        IfStatement: /* @__PURE__ */ continuedIndent({ except: /^\s*({|else\b)/ }),
    ...
    wrap: /* @__PURE__ */ parseMixed((node, input) => {
      ...
      if (tagNode === null || tagNode.type.name !== "VariableName") {
        return null;
      }
      const tag = input.read(tagNode.from, tagNode.to);
      let parser4;
      if (tag === "css") {
        parser4 = cssLanguage.parser;
      } else if (tag === "html") {
        parser4 = htmlLanguage.parser;
      } else {
        return null;
      }
      const overlay = [];
      ...
      if (overlay.length === 0) {
        return { parser: parser4 };
      }
      overlay.push({ from, to: node.to });
      return { parser: parser4, overlay };
    })
  }),
  languageData: {
    closeBrackets: { brackets: ["(", "[", "{", "'", '"', "`"] },
...
var typescriptLanguage = /* @__PURE__ */ javascriptLanguage2.configure({ dialect: "ts" });
var jsxLanguage = /* @__PURE__ */ javascriptLanguage2.configure({ dialect: "jsx" });
var tsxLanguage = /* @__PURE__ */ javascriptLanguage2.configure({ dialect: "jsx ts" });
function javascript2(config2 = {}) {
  let lang = config2.jsx ? config2.typescript ? tsxLanguage : jsxLanguage : config2.typescript ? typescriptLanguage : javascriptLanguage2;
  return new LanguageSupport(lang, [
    javascriptLanguage2.data.of({
...
var android3 = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent);
var autoCloseTags = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text) => {
  if ((android3 ? view.composing : view.compositionStarted) || view.state.readOnly || from != to || text != ">" && text != "/" || !javascriptLanguage2.isActiveAt(view.state, from, -1))
    return false;
  let { state } = view;
  let changes = state.changeByRange((range) => {
    var _a2, _b, _c;
...
function esLint(eslint, config2) {
  ...
  return (view) => {
    ...
    for (let { from, to } of javascriptLanguage2.findRegions(state)) {
...
export {
  ...
  esLint,
  indentWithTab,
  javascript2 as javascript,
  javascriptLanguage2 as javascriptLanguage,
  keymap,
  snippets
};
